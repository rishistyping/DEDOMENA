# Script to register the trained model in Azure Machine Learning workspace(/container registry)
...
model = Model.register(
    ...
    tags={"area": "fradulent", "type": "classification", "run_id": run_id},
    description="Classification model for Credit card transactions dataset",
    workspace=ws,
)
os.chdir("..")
print(
